...
void modificarPaciente(int id, int numPacientes)
{
    int opcion = 0;
    for (int i = 0; i < numPacientes; i++)
    {
        if (id == idPacientes[i])
        {
            ...
            printf("Ingrese 3 para modificar el diagnostico.\n");
            printf("Salir.\n");
            scanf("%d", opcion);
            switch (opcion)
            {
            case 1:
                ...
                nombresPacientes[i][strcsp(nombresPacientes[i],"\n")]=0);
                break;
            case 2:
                printf("Ingrese la edad a modificar: \n");
                fgets(edadesPacientes[i], stdin);
                edadesPacientes[i][strcsp(edadesPacientes[i],"\n")]=0);
                break;
            case 3:
